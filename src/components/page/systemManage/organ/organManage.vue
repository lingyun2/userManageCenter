<template>
	<div class="list-main">
		<div class="search-list" data-u="1232222" @click="test($event)">
			<!-- 日期  -->
			...
			<el-input v-model="organNo" class="search-text mr10 mt10" placeholder="机构编号" size="small"></el-input>
			<el-input v-model="companyName" class="search-text mr10 mt10" placeholder="公司名称" size="small"></el-input>
			<el-input v-model="contacts" class="search-text mr10 mt10" placeholder="联系人" size="small"></el-input>
			<el-input v-model="phone" class="search-text mr10 mt10" placeholder="电话" size="small"></el-input>
		...
		<el-table ref="multipleTable" :data="tableData3" v-loading="loading" border tooltip-effect="dark" style="width: 100%" size="mini">
		    ...
		    <el-table-column prop="role_name" label="机构编号" width="120" show-overflow-tooltip></el-table-column>
		    <el-table-column prop="status" label="机构名称" show-overflow-tooltip></el-table-column>
		    <el-table-column prop="organ_code" label="公司名称" show-overflow-tooltip></el-table-column>
		    <el-table-column prop="create_person" label="联系人" width="120"></el-table-column>
		    <el-table-column prop="create_person" label="电话" width="120"></el-table-column>
		...
		<!-- 详情弹窗 -->
		<el-dialog custom-class="detail-dialog" title="机构详情" :visible.sync="detailDialog" width="30%">
			<el-form :model="form" label-width="100px" size="small">		
			    <el-form-item label="机构名称"><span>云智易联</span></el-form-item>
			    <el-form-item label="机构编号"><span>云智易联</span></el-form-item>
			    <el-form-item label="公司名称"><span>云智易联</span></el-form-item>
			    <el-form-item label="联系人"><span>云智易联</span></el-form-item>
			    <el-form-item label="电话"><span>云智易联</span></el-form-item>
			    <el-form-item label="电子邮件"><span>云智易联</span></el-form-item>
			    <el-form-item label="地区"><span>云智易联</span></el-form-item>
			    <el-form-item label="地址"><span>云智易联</span></el-form-item>
			    <el-form-item label="邮编"><span>云智易联</span></el-form-item>
			    <el-form-item label="状态"><span>云智易联</span></el-form-item>
			    <el-form-item label="备注"><span>云智易联</span></el-form-item>
			    <el-form-item label="合作伙伴编号"><span>云智易联</span></el-form-item>
			    <el-form-item label="合作伙伴密匙"><span>云智易联</span></el-form-item>
			    <el-form-item label="异步通知地址"><span>云智易联</span></el-form-item>
		...
		<!-- 编辑弹窗 -->
		<el-dialog title="编辑机构" :visible.sync="editDialog" width="30%">
		  <el-form :model="form" :rules="rules" label-width="100px" size="small">
		    <el-form-item label="机构名称" prop="name"><el-input v-model="form.name"></el-input></el-form-item>		
		    <el-form-item label="机构编号" prop="name"><el-input v-model="form.name"></el-input></el-form-item>
		    <el-form-item label="公司名称" prop="name"><el-input v-model="form.name"></el-input></el-form-item>
		    <el-form-item label="联系人"><el-input v-model="form.name"></el-input></el-form-item>
		    <el-form-item label="电话"><el-input v-model="form.name"></el-input></el-form-item>
		    <el-form-item label="电子邮件"><el-input v-model="form.name"></el-input></el-form-item>
		    ...
		    <el-form-item label="邮编"><el-input v-model="form.name"></el-input></el-form-item>
		    <el-form-item label="备注"><el-input v-model="form.name"></el-input></el-form-item>
		    <el-form-item label="异步通知地址"><el-input v-model="form.name"></el-input></el-form-item>
		    <el-form-item label="合作伙伴编号"><span>12</span></el-form-item>
		    <el-form-item label="合作伙伴密匙"><span>2212</span></el-form-item>
		  </el-form>					
		  <div slot="footer" class="dialog-footer">
